...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md bg-card border-border text-card-foreground shadow-2xl">
      ...
      <form action={googleAction}>
        {googleState?.error && (
          <div className="rounded-lg border border-destructive/20 bg-destructive/10 p-3 text-sm text-destructive mx-6 mb-4">
            {googleState.error}
          </div>
        )}
